...
public class VendorDAOImpl implements VendorDAO {
    ...
    public List<VendorDetails> getAllData()
    {
    ...
    @Override
    public List<VendorDetails> getDataById(int fileid)
    {
        String sql = "SELECT * FROM \"javaHDBConnet.hdb.data::tables.data\" where \"fileId\" =?";
        List<VendorDetails> vendor = jdbcTemplate
                .query(sql, new VendorDAOMapper(), fileid);
        return vendor;
    }
    ...
    {
        String sql = "insert into \"javaHDBConnet.hdb.data::tables.data\" ("+
			        "\"fileId\",\"recordId\",\"firstName\",\"lastName\",\"companyName\",\"houseNumber\",\"addressLine1\","+
			        "\"addressLine2\",\"city\",\"county\",\"state\",\"postalCode\",\"country\",\"primaryPhone\",\"secondaryPhone\","+
			        "\"email\",\"webLink\",\"taxNumber1\",\"taxNumber2\",\"VATRegNumber\",\"stdCommuMtd\",\"bankKey\","+
			        "\"bankAccount\",\"IBANValue\",\"payTerms\""+
			        ") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void addDataInBatch(List<VendorDetails> vendors)
    {
        ...
        jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
			...
			public void setValues(PreparedStatement ps, int i) throws SQLException {
				...
				ps.setString(6, vendors.get(i).getHouseNumber());
				ps.setString(7, vendors.get(i).getAddressLine1());
				ps.setString(8, vendors.get(i).getAddressLine2());
				ps.setString(9, vendors.get(i).getCity());
				ps.setString(10, vendors.get(i).getCounty());
				ps.setString(11, vendors.get(i).getState());
				ps.setString(12, vendors.get(i).getPostalCode());
				ps.setString(13, vendors.get(i).getCountry());
				ps.setString(14, vendors.get(i).getPrimaryPhone());
				ps.setString(15, vendors.get(i).getSecondaryPhone());
				ps.setString(16, vendors.get(i).getEmail());
				ps.setString(17, vendors.get(i).getWebLink());
				ps.setString(18, vendors.get(i).getTaxNumber1());
				ps.setString(19, vendors.get(i).getTaxNumber2());
				ps.setString(20, vendors.get(i).getVATRegNumber());
				ps.setString(21, vendors.get(i).getStdCommuMtd());
				ps.setString(22, vendors.get(i).getBankKey());
				ps.setInt(23, vendors.get(i).getBankAccount());
				ps.setString(24, vendors.get(i).getIBANValue());
				ps.setString(25, vendors.get(i).getPayTerms());
			}
    ...
    public void deleteFile(int id)
    {
        ...
        sql = "delete from \"javaHDBConnet.hdb.data::tables.metaData\" where \"fileId\" = ? ";
        jdbcTemplate.update(sql, id);
    }
	
	public List<AddressTemplate> getTop50Address(int fileId)
	{
		String sql = "SELECT TOP 50 \"fileId\",\"recordId\",\"houseNumber\",\"addressLine1\",\"addressLine2\",\"city\",\"county\",\"state\",\"postalCode\",\"country\" FROM \"javaHDBConnet.hdb.data::tables.data\" where \"fileId\" = ?";
		List<AddressTemplate> address = jdbcTemplate.query(sql, new AddressMapper(), fileId);
        return address;
	}
